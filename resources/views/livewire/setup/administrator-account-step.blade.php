            ...
            <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden border border-white/50">
                ...
                <div class="p-8 space-y-6">
                    <div class="animate-fade-in-up" style="animation-delay: 0.2s;">
                        <label for="adminNameInput" class="block text-sm font-medium text-[#4A5568] mb-2">
                            {{ __('Name') }}
                        </label>
                        <input
                        ...
                        />
                        <x-input-error for="state.administrator_name" class="mt-2" />
                    </div>

                    <div class="animate-fade-in-up" style="animation-delay: 0.3s;">
                        <label for="adminEmailInput" class="block text-sm font-medium text-[#4A5568] mb-2">
                            {{ __('Email Address') }}
                        </label>
                        <input
                        ...
                        />
                        <x-input-error for="state.administrator_email" class="mt-2" />
                    </div>

                    <div class="animate-fade-in-up" style="animation-delay: 0.4s;">
                        <label for="adminPasswordInput" class="block text-sm font-medium text-[#4A5568] mb-2">
                            {{ __('Password') }}
                        </label>
                        <input
                            ...
                            placeholder="{{ __('********') }}"
                        />
                        <x-input-error for="state.administrator_password" class="mt-2" />
                    </div>

                    <div class="animate-fade-in-up" style="animation-delay: 0.5s;">
                        <label for="adminPasswordConfirmationInput" class="block text-sm font-medium text-[#4A5568] mb-2">
                        ...
                        <input
                            ...
                            placeholder="{{ __('********') }}"
                        />
                        <x-input-error for="state.administrator_password_confirmation" class="mt-2" />
                    </div>
                </div>
