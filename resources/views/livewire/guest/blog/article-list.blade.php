<div class="bg-gradient-to-br from-pink-100 via-purple-100 via-blue-100 to-green-100 min-h-screen p-8 dark:from-purple-900 dark:via-purple-900 dark:to-indigo-900">
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-lg text-purple-600 dark:text-purple-300">
                        ...
                        <div class="mt-8">
                            @foreach($article->tags as $tag)
                                <a href="{{ route('guest.blog.tags.detail', $tag->slug) }}">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-200 hover:bg-purple-200 dark:hover:bg-purple-800 transition-colors duration-200">
                                        {{ $tag->name }}
                                    </span>
                                </a>
                            @endforeach
